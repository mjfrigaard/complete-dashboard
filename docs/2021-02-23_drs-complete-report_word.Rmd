...
```{r bmrn-complete-dashboard-flow-png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-flow.png")
```
...
```{r CriticalVariables, echo=FALSE}
CriticalVariables <- data.frame(
Form = c("Adverse Events","Bleeding History",
  "Bleeding Log","Missed Work/School",
  "Factor VIII Infusions",
  "Subject Disposition",
  "Study Drug Administration",
  "External Lab Data (Covance)"),
Field = c("All","All",
  "All","All","FVIII Dosing",
  "Date, reason","All",
  "FVIII levels and LFT all data to be reconciled"),
`RelatedEndpoint/Comment` = c("Safety",
  "Number of Annualized bleeds experienced by the subject prior to dosing with BMRN270",
  "Number of annualized bleeds experienced by the subject after dosing.",
  "There should be a Work/School form for every Bleeding log form completed",
  "Number of doses of Historic prophylactic FVIII and the Number of FVIII required after administration of the study material.",
  "Study disposition; study follow up time used to calculate annualized bleed rate/FVIII usage.",
  "Dose of study drug administered; follow up time used to calculate annualized bleed rate/FVIII usage.",
  "Safety and Efficacy")
)
knitr::kable(CriticalVariables)
```
...
```{r complete-dashboard-Rmd, echo=FALSE}
fs::dir_tree("..", regexp = 'complete-dashboard', recurse = FALSE)
```
...
```{r summary-Rmd, echo=FALSE}
fs::dir_tree("..", regexp = 'summary', recurse = FALSE)
```
...
```{r bmrn-complete-dashboard-fields.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-fields-1.1.png")
```

Filtered by critical variables 

```{r bmrn-complete-dashboard-fields-critical.pn, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-fields-critical.png")
```

Filtered by missing variables 

```{r bmrn-complete-dashboard-fields-missing, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-fields-missing.png")
```

Filtered by critical and missing

```{r bmrn-bmrn-complete-dashboard-fields-critical-missing.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-fields-critical-missing.png")
```

The Removed Listing page is below:

```{r bmrn-complete-dashboard-removed-1.1.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-removed-1.1.png")
```
...
```{r bmrn-complete-shinyapps-server-side.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-shinyapps-server-side.png")
```
...
```{r bmrn-complete-dashboard-notes-fields.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-notes-fields.png")
```
...
```{r bmrn-complete-dashboard-notes-removed.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-notes-removed.png")
```

When we click the PDF download file, we see 

```{r bmrn-complete-dashboard-notes-fields-pdf.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-notes-fields-pdf.png")
```

And below is the word output. 

```{r bmrn-complete-dashboard-notes-fields-word.png, echo=FALSE}
knitr::include_graphics("../img/bmrn-complete-dashboard-notes-fields-word.png")
```
